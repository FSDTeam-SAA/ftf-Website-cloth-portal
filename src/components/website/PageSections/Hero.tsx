    ...
    return (
        <section className="bg-transparent py-20 px-4 min-h-[600px] flex flex-col items-center justify-center">
            <div className="max-w-6xl w-full">
                ...
                <p className="text-gray-600 text-center text-lg mb-20 font-medium">What do you want to do today?</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <h3 className="text-3xl font-bold text-black mb-4 font-sans">Welcome PJ Team Members </h3>
                    ...
                    >
                        ...
                        <h3 className="text-3xl font-bold text-black mb-4 font-sans">Swag Store</h3>
                        <p className="text-gray-600 mb-8 max-w-[300px] leading-relaxed">
